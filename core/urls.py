...
urlpatterns = [
        ...
        path("withraw_fund_from_card/<card_id>/", credit_card.withraw_fund_from_card ,name="withraw_fund_from_card"),
        path("delete_credit_card/<card_id>/", credit_card.delete_credit_card ,name="delete_credit_card"),
]